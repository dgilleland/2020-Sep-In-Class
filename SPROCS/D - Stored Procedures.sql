...
-- ??) Create a stored procedure called RemoveJobPosition that takes in the name of the position and deletes it from the Position table. Ensure the supplied name is valid and that it exists. Generate your own error message if the attempted delete fails.
