...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <asp:ObjectDataSource ID="CategoryDataSource" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetProductCatalog" TypeName="WestWindSystem.BLL.ProductCatalogController"></asp:ObjectDataSource>
        </div>
    </div>
</asp:Content>
