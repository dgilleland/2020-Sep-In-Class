...
namespace WestWindSystem.BLL
{
    ...
    public class SalesController
    {
        ...
        public List<string> ListCountries()
        {
            using (var context = new WestWindContext())
            {
                // NOTE: This is to demo the use of the Union extension method.
                var eCountries = context.Employees.Select(x => x.Address.Country);
                var cCountries = context.Customers.Select(x => x.Address.Country);
